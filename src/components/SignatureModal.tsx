        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal" onClick={(e) => e.stopPropagation()} style={{ width: '500px' }}>
                <div className="modal-header">
                    <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><DrawIcon /> เซ็นชื่ออนุมัติ</h3>
                ...
                <div className="modal-footer">
                    ...
                    >
                        {loading ? <span className="spinner spinner--sm" /> : <CheckCircleIcon fontSize="small" />} ยืนยันและเซ็นอนุมัติ
                    </button>
                </div>
            </div>
        </div>
